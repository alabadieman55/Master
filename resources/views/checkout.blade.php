                ...
                <form id="payment-form" class="needs-validation">
                    ...
                    <div class="d-block my-3">
                        <div class="form-check custome-radio-box">
                            <input class="form-check-input" type="radio" name="paymentMethod" id="stripe" checked>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', async function(event) {
            ...
            if (result.error) {
                ...
                window.location.href = '{{ route('checkout.success') }}?payment_intent=' + result.paymentIntent.id;
            }
        });
